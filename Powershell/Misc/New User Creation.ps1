...
<OPTIONS Product="Brads Ultimate New User Creation" Version="1.0">
 ...
 <Default>
  <Domain>voiceboxtechnologies.com</Domain>
  <Path>OU=Users,DC=voiceboxtechnologies,DC=com</Path>
  <FirstName></FirstName>
  <LastName></LastName>
  <Office></Office>
  <Title></Title>
  <Description>Pikes Peak - Full Time Employee</Description>
  <Department></Department>
  <Company>VoiceBox Technologies</Company>
  <Phone></Phone>
  <Site>Washington</Site>
  <StreetAddress>11980 NE 24th St</StreetAddress>
  <City>Bellevue</City>
  <State>WA</State>
 ...
 <Domains>
  <Domain Name="voiceboxtechnologies.com">
   <Path>OU=Users,DC=voiceboxtechnologies,DC=com</Path>
   <Path>CN=Users,DC=voiceboxtechnologies,DC=com</Path>
  </Domain>
 </Domains>
 
 <Descriptions>
  <Description>Pikes Peak - Full Time Employee</Description>
  <Description>Pikes Peak - Part-Time Employee</Description>
  <Description>Pikes Peak - Contractor</Description>
  <Description>Pikes Peak - Intern</Description>
  <Description>Mountain Pacific West - Full Time Employee</Description>
  <Description>Mountain Pacific West - Part-Time Employee</Description>
  <Description>Mountain Pacific West- Contractor</Description>
  <Description>Mountain Pacific West - Intern</Description>
  <Description>Works at Home - Full Time Employee</Description>
  <Description>Works at Home - Part-Time Employee</Description>
  <Description>Germany - Employee</Description>
  <Description>Japan - Employee</Description>
  <Description>Munich - Employee</Description>
  <Description>Portugal - Employee</Description>
  <Description>Netherlands - Employee</Description>
  <Description>Service Account</Description>
 </Descriptions>
 
 <Departments>
  <Department>Accounting</Department>
  <Department>Application Engineering</Department>
  <Department>Automotive Engineering</Department>
  <Department>Customer Engineering</Department>
  <Department>Executive Management</Department>
  <Department>Home Products</Department>
  <Department>Human Resources</Department>
  <Department>IT</Department>
  <Department>Localization</Department>
  <Department>Marketing</Department>
  <Department>Mobile Development</Department>
  <Department>NLU</Department>
  <Department>Platform Engineering</Department>
  <Department>QA</Department>
  <Department>SLT</Department>
  <Department>Speech Reasearch and Development</Department>
 </Departments>
...
function Call-ANUC_pff {
	...
	$lvCSV_SelectedIndexChanged={
		try{$txtDomain.SelectedItem = $lvCSV.SelectedItems[0].SubItems[1].Text}catch{}
