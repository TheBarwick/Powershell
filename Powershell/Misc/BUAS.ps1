#========================================================================
# Generated On: 08/19/2014 6:18 PM
# Generated By: Brad Stevens
#========================================================================
#----------------------------------------------
...
function Call-BUAS_pff {
	...
	$btnAddNewUser_Click={ powershell "\\filer\documents\IT\Scripts\New_User_Creation.ps1"}
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
            ...
            $btnAddNewUser.remove_Click($btnAddNewUser_Click)
    ...
    $formMain.Controls.Add($userInfo)
    ...
    # userInfo
    #
    $userInfo.Controls.Add($btnAddNewUser)
    $userInfo.Location = '10, 488'
    $userInfo.Name = "userInfo" 
    $userInfo.Size = '126, 63'
    $userInfo.TabIndex = 7
    $userinfo.TabStop = $False
    $userInfo.Text = "User Administration"
	#
	# groupInfo
	#
