...
Try{
$Session = New-PSSession -Name "Online-Exchange" -ConfigurationName Microsoft.Exchange -ConnectionUri https://ps.outlook.com/powershell-liveID/ -Credential $LiveCred -Authentication Basic -AllowRedirection  -erroraction silentlycontinue
