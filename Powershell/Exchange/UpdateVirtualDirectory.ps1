...
#
# Sources mentioned by Nathan (e.g. exchangeninjas.com and Barry Martin blog) are unavailable now but I'd like to thank all of the previous authors of this script
#
# Version 1.2
#
...
Write-host “” 
[string]$base = Read-host “Virtual Directory Root: ” 
write-host “” 

# ============================================= 
# Validate if OAB downloads are delivered with HTTP or HTTPS protocol  
[string]$set = Read-host “Do you want to use HTTP instead of HTTPS for OAB? (Y/N)” 
Write-host “” 
